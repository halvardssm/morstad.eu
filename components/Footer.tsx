...
export default function Footer() {
  return <footer
    className="w-full text-center border-t border-grey p-4 pb-2 sticky bottom-0 bg-white dark:bg-black"
  >
    <div className="w-full max-w-4xl mx-auto flex content-center">
      ...
      <div className="flex-auto">
        <Popover className="relative">
          ...
          <Popover.Panel
            className="absolute z-10 right-0 bottom-16 bg-white dark:bg-black w-40 flex flex-col p-2 py-3 rounded-sm border border-grey"
          >
