...
import { TAGS, TW_COLORS } from "../contstants";
import { useEffect, useState } from "react";

export const useMappedTags = (): [TagT[]|undefined, ((code: string, isSelected: boolean) => void)] => {
  ...
  const setIsSelected = (code: string, isSelected: boolean) => {
    setTags((prevTags=[]) => prevTags.map(it => it.code === code ? { ...it, isSelected: isSelected } : it));
  };
