...
import {
  IconHome, IconArrowLeft, IconBrandGithub, IconBrandLinkedin, IconMail,
  IconMoon, IconSun, IconCode, IconBulb, IconUsers,
  IconCloud, IconSchool, IconMusic, IconKey, IconRuler2, IconShip,
  ...
  IconLanguage, IconRobot, IconFolder, IconVirus, IconPointer, IconClick, IconStar,
