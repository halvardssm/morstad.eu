...
export default function Portfolio() {
    ...
    return PROJECTS.filter((el) =>
      ...
      .map((project, i) => {
        return <div key={i} className="break-inside w-full mb-4">
          <article
            className="overflow-hidden rounded-lg shadow-lg dark:shadow-none border border-white"
          >
            <header
  ...
  return (
    <div className="flex flex-col justify-between h-screen">
      ...
      <main
        className="pt-5 pb-5 mx-auto flex-grow flex flex-col max-w-screen-2xl"
      >
        ...
        <div
          className="masonry-1-col sm:masonry-2-col lg:masonry-3-col 2xl:masonry-4-col m-5 flex-grow"
        >
